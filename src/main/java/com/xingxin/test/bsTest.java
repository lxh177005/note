...
public class bsTest {
    public static void main(String[] args) {
        ...
        user.setId(1);
        user.setName("zs");
        String string3 = JSON.toJSONString(user);
        System.out.println("string3 = " + string3);
        Cinema cinema = new Cinema();
        String string2 = cinema.toString();
        System.out.println("string2 = " + string2);
        System.out.println("cinema = " + cinema);
        boolean empty2 = ObjectUtils.isEmpty(cinema);
        System.out.println("empty2 = " + empty2);

        boolean b2 = com.xingxin.utils.ObjectUtils.checkObjAllFieldsIsNull(cinema);
